...
$(BIN_DIR)/engine_tests: $(OBJ_DIR)/Engine_t.o $(OBJ_DIR)/Figure.o $(OBJ_DIR)/Board.o $(OBJ_DIR)/Engine.o $(OBJ_DIR)/SocketLog.o $(OBJ_DIR)/Socket.o $(OBJ_DIR)/Utils.o Board.h Figure.h Field.h Engine.h
	$(CXX) $(CFLAGS) -o $(BIN_DIR)/engine_tests $(OBJ_DIR)/Engine_t.o $(OBJ_DIR)/Figure.o $(OBJ_DIR)/Board.o $(OBJ_DIR)/Engine.o $(OBJ_DIR)/SocketLog.o $(OBJ_DIR)/Socket.o $(OBJ_DIR)/Utils.o

$(BIN_DIR)/game: $(OBJ_DIR)/Game.o $(OBJ_DIR)/Engine.o $(OBJ_DIR)/Figure.o $(OBJ_DIR)/Board.o $(OBJ_DIR)/PgnCreator.o $(OBJ_DIR)/SocketLog.o $(OBJ_DIR)/Socket.o $(OBJ_DIR)/Utils.o Board.h Figure.h Field.h
	$(CXX) $(CFLAGS) -o $(BIN_DIR)/game $(OBJ_DIR)/Game.o $(OBJ_DIR)/Engine.o $(OBJ_DIR)/Figure.o $(OBJ_DIR)/Board.o $(OBJ_DIR)/PgnCreator.o $(OBJ_DIR)/SocketLog.o $(OBJ_DIR)/Socket.o $(OBJ_DIR)/Utils.o

$(BIN_DIR)/uci_engine: $(OBJ_DIR)/UCIEngine.o $(OBJ_DIR)/UCIHandler.o $(OBJ_DIR)/Engine.o $(OBJ_DIR)/Figure.o $(OBJ_DIR)/Board.o $(OBJ_DIR)/SocketLog.o $(OBJ_DIR)/Socket.o $(OBJ_DIR)/Utils.o Board.h Figure.h Field.h
	$(CXX) $(CFLAGS) -o $(BIN_DIR)/uci_engine $(OBJ_DIR)/UCIEngine.o $(OBJ_DIR)/UCIHandler.o $(OBJ_DIR)/Engine.o $(OBJ_DIR)/Figure.o $(OBJ_DIR)/Board.o $(OBJ_DIR)/SocketLog.o $(OBJ_DIR)/Socket.o $(OBJ_DIR)/Utils.o
...
$(OBJ_DIR)/UCIHandler.o: UCIHandler.cc UCIHandler.h Board.h Figure.h Field.h utils/SocketLog.h utils/Socket.h utils/Utils.h
	$(CXX) $(CFLAGS) -c -o $(OBJ_DIR)/UCIHandler.o UCIHandler.cc

$(OBJ_DIR)/Engine.o: Engine.cc Engine.h Board.h Figure.h Field.h utils/SocketLog.h utils/Utils.h
